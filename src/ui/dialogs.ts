                ...
                <div class="note-dialog" data-data-dir="${p}">
                    <div class="note-summarize-config">
                        <div class="note-title-container">
                            ...
                            <blockquote style="border-left: 5px solid #007bff; padding-left: 10px; color: #007bff; background-color: #f9f9f9;">
                                <p><i class="fas fa-info-circle"></i> The summarisation will be only saved above the current note. If you wish to have a summary in the panel, you have to craft the summary there.</p>
                            </blockquote>
                        </div>
